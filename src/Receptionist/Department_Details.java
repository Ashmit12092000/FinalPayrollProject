...
public class Department_Details implements ActionListener
{
    ...
    public Department_Details()
    {
        ...
        try{
            ...
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/hotel_db", "root", "");
            String sql="SELECT room from rooms where status=?";
            ...
            int i=0;
            while(rs.next()){
                String Dep_id=rs.getString("room");
                //String Dep_name=rs.getString("Depart_name");
                model.addRow(new Object[]{Dep_id});
                i++;
            }
