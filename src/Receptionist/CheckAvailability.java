...
class CheckAvailability extends JFrame implements ActionListener{
    ...
    CheckAvailability(){
        ...
        l = new JLabel("Check Availability");
        l.setSize(300,40);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (str.equals("Check Availability")){
            ...
            try{
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost/hotel_db","root","");

                PreparedStatement st = (PreparedStatement) con.prepareStatement("Insert into department values(?,?)");
                st.setInt(1,id);
                st.setString(2,name);
                st.executeUpdate();
