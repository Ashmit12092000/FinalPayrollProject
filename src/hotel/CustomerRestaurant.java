...
public class CustomerRestaurant extends JFrame {
	...
	public CustomerRestaurant() {
		try {
			UIManager.setLookAndFeel("com.tattoo.play.aluminium.AluminiumLookAndFeel");
		}catch(Exception e) {
			e.printStackTrace();
		}
		...
		Image temp=img.getScaledInstance(1250,650,Image.SCALE_SMOOTH);
		background=new ImageIcon(temp);
		JLabel backs=new JLabel(background);
		backs.setBounds(0,0,1250,650);
